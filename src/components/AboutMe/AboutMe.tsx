  ...
  <section className="about">
    ...
    <section className="profile">
      <div className="profile__content">
        ...
        <p>It's been a wild ride. In the past two years, I've:
          <ul>
    ...
    <section className="personal">
      ...
      <div className="personal__content">
        ...
        <p>I was going to think of something clever to say, but then I lost electricity for much of the weekend and was forced to battle Chrome download limits. 
          Sadly, there wasn't much time left to impress with you words.</p>
